...
import { formatModelName, isEstimatedLog, parseLogOther } from '../lib/format'
import {
  getLogTypeConfig,
...
export function CommonLogMobileCard<TData>(props: {
  ...
  // 估计 token 标记：上游未返回 usage 时后端按估算值记账，移动端需给出「?」提示喵。
