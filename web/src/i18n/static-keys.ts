...
export const STATIC_I18N_KEYS = [
  ...
  '3D generation',
  'Image generation',
  'Enable conversational chat in Playground.',
  'Enable image generation and editing in Playground.',
  'Enable text-to-speech generation in Playground.',
  'Enable asynchronous 3D generation in Playground.',
  'Edit image',
  'Generate image',
  'No voices found',
  'Request price',
